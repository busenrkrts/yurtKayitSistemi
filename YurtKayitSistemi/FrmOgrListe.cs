...
namespace YurtKayitSistemi
{
    public partial class FrmOgrListe : Form
    {
        ...
        {
            secilen = dataGridView1.SelectedCells[0].RowIndex; //seçilen satırın id bilgisini çekme
            //frmOgrDuzenle formunda ayarladığımız id label ına daatgridden seçilen satırdaki id bilgisini getirme
